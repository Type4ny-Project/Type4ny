...
- Misskey最新版に追従しました。
- Fix: 軽微なバグを複数修正しました
- Security: セキュリティーパッチをマージしました
- Enhance: ギャラリーの説明を一番上に表示するように
- Enhance: ギャラリーのサムネイルでホバーしたときにぼかしが外れないように
...
- Fix: User Webhookテスト機能のMock Payloadを修正- Fix: アカウント削除のモデレーションログが動作していないのを修正 (#14996)
